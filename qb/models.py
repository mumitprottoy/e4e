...
class QuestionMetaData(models.Model):
    ...
    @classmethod
    def get_answer_map(cls, bulk: models.QuerySet) -> dict:
        return {q.id: q.correct_option.id for metadata in bulk for q in metadata.questions.all()}
...
class Appearance(models.Model):
    ...
    @property
    def label(self):
        return f'{self.university.acronym} {self.unit} {self.year}'
